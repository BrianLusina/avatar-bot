"""
Configurations for flask application. These are global variables that the app will use
"""
import os
...
class Config(object):
    ...
    SECURITY_PASSWORD_SALT = os.environ.get("SECURITY_PASSWORD_SALT") or "avatar-bot"
